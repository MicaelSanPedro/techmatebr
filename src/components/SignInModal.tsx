        ...
        <div className="p-6 sm:p-8">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-sm text-white/45">
              Faca login para salvar seus favoritos e sincronizar entre dispositivos
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-[11px] text-white/25 uppercase tracking-wider font-medium">Opcoes de login</span>
            <div className="flex-1 h-px bg-white/[0.06]" />
          </div>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <span className="text-sm font-medium text-white/80 group-hover:text-white transition-colors">
                {loadingProvider === "github" ? "Entrando..." : "Continuar com GitHub"}
              </span>
